...
CS = plt.contour(x_grid, y_grid, grid1, 20,
                 linestyles='dashed', linewidths=1, cmap='Reds')
plt.plot(x_grid[Xmax, Ymax], y_grid[Xmax, Ymax], '.r', markersize=8)
plt.clabel(CS, inline=1, fontsize=10)
plt.plot(points[0:10, 0], points[0:10, 1], 'k')
plt.plot(points[11:20, 0], points[11:20, 1], 'k')
plt.text(x_grid[Xmax, Ymax]+30, y_grid[Xmax, Ymax] +
